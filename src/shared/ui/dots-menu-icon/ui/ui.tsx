...
export function DotsButton({ModalSlot, isOpened = false, onClick, onModalClick, isModalOpened}: PropsType) {
    ...
    return <Button className={`dots-button${isOpened ? " opened" : ""}`} onClick={onClick} withAnimation={false}>
        <svg className="dots-button__icon" xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24"
