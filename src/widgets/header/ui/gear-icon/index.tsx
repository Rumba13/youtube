...
export function GearIcon() {
    return <div className="gear-icon">
        <svg className="gear-icon__icon" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24"
        ...
        <div className="gear-icon__interaction"></div>
        <TextTip>Настройки</TextTip>
    </div>
}