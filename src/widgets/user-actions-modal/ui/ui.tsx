        ...
        <VerticalList className="user-actions-list" listItemClassName="user-actions-list__item" items={[
            <a className="item-link"
               href="https://myaccount.google.com/u/1/?utm_source=YouTubeWeb&tab=rk&utm_medium=act&tab=rk&hl=ru">
                <SvgIcon className="item-icon" Icon={GoogleIcon}/> Аккаунт Google
            </a>,
            <a className="item-link">
                <SvgIcon className="item-icon" Icon={AccountChangeIcon}/> Сменить аккаунт
                <SvgIcon className="arrow"
                         Icon={ArrowIcon}/>
            </a>,
            <a className="item-link">
                <SvgIcon className="item-icon" Icon={ExitIcon}/> Выйти
            </a>,
            <a className="item-link" href="https://studio.youtube.com/channel/UC6Kav4lZ1H0SNIUidzfXwdA">
                <SvgIcon
                    className="item-icon" Icon={CreatorStudioIcon}/> Творческая студия YouTube
            </a>,
            <a className="item-link" href="https://www.youtube.com/paid_memberships?ybp=mAEK">
                <SvgIcon
                    className="item-icon" Icon={MoneyIcon}/> Покупки и платные подписки
            </a>,
            <a className="item-link" href="https://myaccount.google.com/u/1/yourdata/youtube?hl=ru">
                <SvgIcon
                    className="item-icon" Icon={AccountIcon}/> Ваши данные на YouTube
            </a>,
            <a className="item-link">
                <SvgIcon className="item-icon" Icon={MoonIcon}/> Тема: как на устройстве
                <SvgIcon className="arrow"
                         Icon={ArrowIcon}/>
            </a>,
            <a className="item-link">
                <SvgIcon className="item-icon" Icon={LanguageIcon}/> Язык: Русский
                <SvgIcon className="arrow"
                         Icon={ArrowIcon}/>
            </a>,
            <a className="item-link">
                <SvgIcon className="item-icon" Icon={ShieldIcon}/> Безопасный режим: откл.
                <SvgIcon className="arrow"
                         Icon={ArrowIcon}/>
            </a>,
            <a className="item-link">
                <SvgIcon className="item-icon" Icon={WorldIcon}/> Страна: Беларусь
                <SvgIcon className="arrow"
                         Icon={ArrowIcon}/>
            </a>,
            <a className="item-link">
                <SvgIcon className="item-icon" Icon={KeyboardIcon}/> Быстрые клавиши
            </a>,
            <a className="item-link" href="https://www.youtube.com/account">
                <SvgIcon className="item-icon"
                         Icon={GearIcon}/> Настройки
            </a>,
            <a className="item-link">
                <SvgIcon className="item-icon" Icon={QuestionIcon}/> Справка
            </a>,
            <a className="item-link">
                <SvgIcon className="item-icon" Icon={DialogIcon}/> Отправить отзыв
            </a>,
        ]}/>
    </div>
}